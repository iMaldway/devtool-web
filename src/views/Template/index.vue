    ...
    <el-row>
      <el-form :inline="true" :model="searchForm" ref="searchFormRef">
        <el-form-item prop="name">
          <el-input class="__oooo__" v-model="searchForm.name" placeholder="名称">
          </el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-dialog v-if="dialog.visible" :close-on-click-modal="false"
      ...
      <el-form :model="dataForm" :rules="dataFormRules" ref="dataFormRef"
        ...
        <el-form-item label="作者名称" prop="author">
          <el-input v-model="dataForm.author" placeholder="作者名称">
          </el-input>
        </el-form-item>
        ...
        <el-form-item label="描述信息" prop="describe">
          <el-input v-model="dataForm.describe" placeholder="描述信息">
          </el-input>
        </el-form-item>
      </el-form>
...
export default defineComponent({
  name: 'Template',
  setup() {
    let controller: any = new TemplateController()
    return {
      ...controller
    }
  }
